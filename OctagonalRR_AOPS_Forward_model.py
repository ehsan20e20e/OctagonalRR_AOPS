...
result = pd.read_csv("OctagonalRR_AOPS_V.csv", header=None)
...
# Output is the transmission value at the wavelength (800 points for output port 1 and 800 points for outpot port 2)
Model = Sequential()
