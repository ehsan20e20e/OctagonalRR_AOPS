...
json_file = open("OctagonalRR_AOPS_forward_model.json", "r")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = keras.models.model_from_json(loaded_model_json)
loaded_model.load_weights("OctagonalRR_AOPS_forward_model_weights.h5")
loaded_model.summary()

# Lower sample
result3 = pd.read_csv("OctagonalRR_AOPS_Fig_04bc_Lower_sample.csv", header=None)
...
# FDTD origin
result4 = pd.read_csv("OctagonalRR_AOPS_Fig_04bc_FDTD_origin.csv", header=None)
...
# Higher sample
result5 = pd.read_csv("OctagonalRR_AOPS_Fig_04bc_Higher_sample.csv", header=None)
